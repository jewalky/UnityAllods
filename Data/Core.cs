...
namespace Allods.Shared
{
    ...
    class Core
    {
        static IWin32Window MainWindowReal = null;
        static public IWin32Window MainWindow
        {
            get
            {
                return MainWindowReal;
            }
        }

        public static void SetMainWindow(IWin32Window wnd)
        {
            if (MainWindowReal != null)
                throw new SystemException("Tried to set the MainWindow twice");
            MainWindowReal = wnd;
        }

        public static void Abort(string format, params string[] args)
        {
